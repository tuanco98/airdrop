import { config_NODE_ENV } from "./config";
...
const successConsoleLog = (msg: string) => console.log(colours.fg.green, `✔️ ${msg}`, colours.reset)
...
export { colours, successConsoleLog, warningConsoleLog, errorConsoleLog, consoleLogDev }